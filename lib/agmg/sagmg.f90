...
PRIVATE
PUBLIC :: sagmg_relmem, sagmg_partroword
PUBLIC :: sagmg_setupL1, sagmg_smoothsetup
...
CONTAINS
  ...
  SUBROUTINE sagmg_partroword(n, a, ja, ia, idiag, w, iw, iext, nzext)
    IMPLICIT NONE
...
200 CONTINUE
  ...
  SUBROUTINE sagmg_setupL1(n,a,ja,ia,listrank,ifl)
    USE sagmg_mem
    IMPLICIT NONE
    INTEGER :: n
    INTEGER :: ja(*),ia(n+1)
...
958 FORMAT('****','              Weighted complexity:',f9.2)
  ...
  RECURSIVE SUBROUTINE sagmg_setup(l,n,listrank)
    USE sagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n
...
924 FORMAT('****','        Number of variables:',i12)
  ...
  SUBROUTINE sagmg_aggregation(l,n,a,ja,ia,nc,listrank)
    USE sagmg_mem
    IMPLICIT NONE
    INTEGER :: l,n,nc
    INTEGER :: ja(*),ia(n+1)
...
901    FORMAT(i3, &
  ...
  SUBROUTINE sagmg_LAPACK(n,f,ijb,a,ja,ia)
    USE sagmg_mem
    IMPLICIT NONE
    INTEGER :: n,ijb
 ...
 910 FORMAT(i3,'*ENTERING AGMG **********************************',&
    ...
    ELSE
     ...
     END IF
      ...
      CALL sagmg_partroword(n,a,ja,ia,dt(1)%idiag,w,iw)
      DEALLOCATE(w,iw)
      CALL sagmg_setupL1(n,a,ja,ia,listrank,ifirstlistrank)
